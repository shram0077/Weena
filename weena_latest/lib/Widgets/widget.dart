...
import 'package:weena_latest/Screens/Upload/Step1.dart';
import 'package:weena_latest/Screens/Upload/createFeed.dart';
import 'package:weena_latest/Widgets/profile_ImagePreview.dart';
...
backButton(ctx, double size) {
  return IconButton(
    ...
    icon: Icon(Icons.arrow_back_ios_new, color: Colors.black, size: size),
  );
}
  ...
  return Padding(
    ...
    child: Row(
      ...
      children: [
        GestureDetector(
          onTap: () {},
          child: const CircleAvatar(radius: 20, backgroundColor: unColor),
        ),
        GestureDetector(
          onLongPress: () {},
          child: Container(
      ...
      children: [
        Row(
          children: [
            ...
            userModell.verification ? verfiedBadge(23, 23) : const SizedBox(),
            userModell.admin ? adminBadge(20, 20) : const SizedBox(),
...
videoCard(PostModel postModel, context, String currentVideoId) {
                            ...
                            children: [
                              ...
                              Flexible(
                                child: Text(
                                  ...
                                  overflow: TextOverflow.ellipsis,
                                  style: GoogleFonts.barlow(color: shadowColor),
                                ),
                              ),
                            ],
                          ),
...
followingandFollowers(int followingCount, int followersCount) {
  return Padding(
    ...
    child: Row(
      children: [
        ...
        Container(width: 1, height: 11, color: Colors.grey.shade400),
        const SizedBox(width: 6),
        Text(
  ...
  return GestureDetector(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: Color.fromARGB(255, 168, 58, 58).withOpacity(0.1),
            spreadRadius: 2,
            blurRadius: 2,
            offset: const Offset(0, 2),
          ),
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        ...
        image: DecorationImage(
          image: CachedNetworkImageProvider(admIMG),
          fit: BoxFit.contain,
        ),
      ),
    ),
                  ...
                  onTap: () {
                    Navigator.push(
                      ...
                      PageTransition(
                        ...
                        child: CreateFeed(currentUserId: currentUserId),
                      ),
                    );
                  },
                  tileColor: Colors.black,
                  leading: Icon(Icons.feed, color: whiteColor),
                  title: text(
                    'فیید',
                    whiteColor,
                    17,
                ...
                ListTile(
                  onTap: () {
                    Navigator.push(
                      ...
                      PageTransition(
                        type: PageTransitionType.topToBottom,
                        child: Step1(currentUserId: currentUserId),
                      ),
                    );
                  },
                  tileColor: Colors.black,
                  leading: Icon(Icons.movie_creation, color: whiteColor),
                  title: text(
                    'فیلم،زنجیرە،دراما،ئەنیمەیشن...',
                    whiteColor,
                    17,
                    FontWeight.w500,
                    TextDirection.rtl,
  ...
  return Center(
    child: Column(
      ...
      children: [
        ...
        text(
          ".پێویستە کرداری چوونەژوورەوەت ئەنجام دابێت",
          appBarColor,
          20,
          FontWeight.normal,
          TextDirection.ltr,
        ...
        MaterialButton(
          ...
          onPressed: () {
            Navigator.push(
              ...
              PageTransition(
                type: PageTransitionType.rightToLeft,
                child: const WelcomeScreen(isSkiped: true),
              ),
            );
          },
