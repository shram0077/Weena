...
const Color moviePageColor = Color.fromARGB(255, 91, 80, 170);
...
const String androidUitId = "5348869";
const String placementId = "Interstitial_Android";
const String androidbannerAds = "Banner_Android";
