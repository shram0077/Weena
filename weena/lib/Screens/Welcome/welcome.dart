...
import 'package:weena/Screens/SignUP_SignIn/SignIn.dart';
import 'package:weena/Screens/SignUP_SignIn/SignUp.dart';
import 'package:weena/Screens/bottomNavigation/bottomNAV.dart';
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: ShapeDecoration(
                  color: const Color.fromARGB(110, 224, 222, 222),
                  shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(9)),
                ),
                child: Center(
                  child: text('سیاسەتی بەکارهێنان', Colors.black, 15,
                      FontWeight.normal, TextDirection.rtl),
                ),
              ),
            ),
