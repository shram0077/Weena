...
import 'package:weena_latest/Screens/Chats/ChatWidget.dart';
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: text(
                    '${timeago.format(widget.userModell.activeTime.toDate(), allowFromNow: true)}',
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  ...
                  blurRadius: 2,
                  color: Color.fromARGB(255, 58, 58, 58).withOpacity(0.9),
                ),
              ],
            ),
            child: SafeArea(
